                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="birth_date" type="text" class="form-control @error('birth_date') is-invalid @enderror" name="first_name" value="{{ old('birth_date') }}" required autocomplete="birth_date" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="housenumber" class="col-md-4 col-form-label text-md-end">{{ __('Housenumber') }}</label>
